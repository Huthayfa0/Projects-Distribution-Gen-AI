...
private SimpleIntegerProperty ThirdChoice;
    ...
    public  static ArrayList<StudentTableView> read() throws FileNotFoundException {
        ...
        Scanner sc = new Scanner(new File("C:\\Users\\Ameer\\OneDrive\\Desktop\\AIProjects1191015 (4)\\AIProjects1191015\\src\\main\\resources\\com\\main\\ai1\\StudentsSelections.csv"));
        sc.nextLine();
        String groups1="";
        int first=0;
        int second=0;
